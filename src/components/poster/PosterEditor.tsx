    ...
    <div className="space-y-4 md:space-y-6">
      <div>
        ...
        <input
          ...
          className="w-full px-3 md:px-4 py-2.5 md:py-3 min-h-[44px] border-2 border-gray-300 rounded-lg focus:ring-4 focus:ring-emerald-200 focus:border-emerald-500 transition-all text-base md:text-lg font-semibold"
      ...
      <div>
        ...
        <textarea
          ...
          rows={5}
          className="w-full px-3 md:px-4 py-2.5 md:py-3 border-2 border-gray-300 rounded-lg focus:ring-4 focus:ring-emerald-200 focus:border-emerald-500 transition-all resize-none"
